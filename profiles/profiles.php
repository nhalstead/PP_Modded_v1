...
<fieldset> 
<center>
<legend>User profile form requirement<?php echo doTell($_SESSION['UPDATE'])?" (Updated)":""; ?></legend>
</center>
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    <input id="email" name="email" type="text" placeholder="" value="<?php echo doTell($userData['email']); ?>" class="form-control input-md">  
      </div>
  </div>
</div>
<div class="form-group">
...
<div class="form-group">
  ...
  <div class="input-group">
   ...
   <input id="zipcode" name="zipcode" type="text" placeholder="" value="<?php echo doTell($userData['zipcode']); ?>" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    <input id="phone" name="phone" type="text" placeholder="" value="+45 <?php echo doTell($userData['phone']); ?>" class="form-control input-md">   
      </div>
  </div>
</div>
<div class="form-group">
